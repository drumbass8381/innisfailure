# PRO version of Innisfailures Trade Bot
# You must have access to the private repository to build this image
# https://github.com/bludnic/innisfailures-pro
...
# Install innisfailures-pro git submodule
ARG GITHUB_TOKEN
RUN rm -rf pro
RUN git config --global url."https://${GITHUB_TOKEN}@github.com/".insteadOf "https://github.com/"
RUN git clone https://github.com/bludnic/innisfailures-pro.git pro
