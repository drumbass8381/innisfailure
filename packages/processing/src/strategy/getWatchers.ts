import { TBotWithExchangeAccount } from "@innisfailures/db";
import { isValidSymbol } from "@innisfailures/tools";
import { BotTemplate, IBotConfiguration, WatchCondition, Watcher } from "@innisfailures/bot-processor";
