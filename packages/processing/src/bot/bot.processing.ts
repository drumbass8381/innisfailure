import type { BotState, IBotConfiguration } from "@innisfailures/bot-processor";
import { createStrategyRunner } from "@innisfailures/bot-processor";
import { findStrategy } from "@innisfailures/bot-templates/server";
import { exchangeProvider } from "@innisfailures/exchanges";
import type { TBotWithExchangeAccount } from "@innisfailures/db";
import { xprisma } from "@innisfailures/db";
import { logger } from "@innisfailures/logger";
import type { ExchangeCode, MarketData, MarketId, MarketEventType } from "@innisfailures/types";
