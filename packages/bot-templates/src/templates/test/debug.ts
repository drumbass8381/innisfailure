import { z } from "zod";
import type { ISymbolInfo } from "@innisfailures/types";
import type { IExchange } from "@innisfailures/exchanges";
import type { IBotConfiguration, TBotContext } from "@innisfailures/bot-processor";
import { useExchange } from "@innisfailures/bot-processor";
