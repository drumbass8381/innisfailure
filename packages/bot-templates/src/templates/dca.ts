import { evaluateConditions, extractIndicators, IndicatorsValues, requiredHistory } from "@innisfailures/tools";
import { z } from "zod";
import { logger } from "@innisfailures/logger";
import { BarSize, XOrderType } from "@innisfailures/types";
import {
  useDca,
  cancelSmartTrade,
  IBotConfiguration,
...
} from "@innisfailures/bot-processor";
