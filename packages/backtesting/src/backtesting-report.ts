...
import type { BotTemplate, IBotConfiguration, Order, Trade } from "@innisfailures/bot-processor";
import { ICandlestick, XOrderStatus } from "@innisfailures/types";
import { format } from "@innisfailures/logger";
