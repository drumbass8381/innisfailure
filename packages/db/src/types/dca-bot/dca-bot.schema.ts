import { z } from "zod";
import { zt } from "@innisfailures/prisma";

import { XOrderType } from "@innisfailures/types";
import { ZBotState } from "../bot/bot-state.schema.js";

// Keep `ZDcaBotSettings` in sync with `dca.schema` from @innisfailures/bot-templates
